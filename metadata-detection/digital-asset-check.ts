...
const erc725js = new ERC725(lsp4Schema, assetContractAddress, 'https://rpc.lukso.gateway.fm', {});
...
if (isLSP4) {
  console.log(`✅ The contract: ${assetContractAddress} supports the LSP4DigitalAsset standard`);
} else {
  console.log(
